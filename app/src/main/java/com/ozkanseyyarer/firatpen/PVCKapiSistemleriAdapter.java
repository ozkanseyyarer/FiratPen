...
public class PVCKapiSistemleriAdapter extends ArrayAdapter<String> {
    ...
    public PVCKapiSistemleriAdapter(@NonNull Context context, String[] urunler, int[] resimler, int[] fiyatlar) {
        super(context,R.layout.pvckapi_sistemleri_item,urunler);
