...
public class AcilimSeceneklerineGorePVCPencereSecenekleriAdapter extends ArrayAdapter<String> {
...
public AcilimSeceneklerineGorePVCPencereSecenekleriAdapter(@NonNull Context context, String[] urunler, int[] resimler, int[] fiyatlar) {
        super(context,R.layout.acilimseceneklerinegore_item,urunler);
